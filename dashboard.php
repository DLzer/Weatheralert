<?php include('header.php');?>
                            ...
                            <div class="col-xl-8">
                                <div class="card sameheight-item items" data-exclude="xs,sm,lg">
                                    <div class="card-header bordered">
                                        <div class="header-block">
                                            <h3 class="title"> Items </h3> <a href="item-editor.php" class="btn btn-primary btn-sm rounded">
            				Add new
            			</a> </div>
                                                ...
                                                <span>Meeting with embassador</span>
                                                    ...
                                                    <i class="fa fa-chevron-circle-right"></i>
                                                                ...
                                                                <i class="fa fa-check"></i>
                                                                        ...
                                                                        <li> <a class="edit" href="item-editor.php">
                ...
                <footer class="footer">
                    <div class="footer-block author">
                        <ul>
                            <li> created by <a href="https://fischsolutions.com">Fisch Solutions</a> </li>
                            <li> <a href="https://fischsolutions.com/contact">get in touch</a> </li>
                        </ul>
                    </div>
                </footer>
